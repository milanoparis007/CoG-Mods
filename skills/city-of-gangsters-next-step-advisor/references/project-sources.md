...
1. `C:\Users\User\AppData\LocalLow\SomaSim\City of Gangsters\Player.log`
2. `C:\Users\User\AppData\LocalLow\SomaSim\City of Gangsters\Player-prev.log`
3. `docs/multi-crew-vehicle-plan.md`
4. `docs/compatibility-matrix.md`
5. `CLAUDE.md`

Do not use repo-root log copies as live evidence. Treat the AppData logs as authoritative.
...
5. `BossDeath/BossDeathPlugin.cs`
   Why: repeated `BossRoleSetter` null warnings in the AppData `Player.log`.
