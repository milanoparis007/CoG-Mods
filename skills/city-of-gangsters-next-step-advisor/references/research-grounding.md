...
Original source material lives in the main skill here:

1. `C:/Users/User/.codex/skills/city-of-gangsters-mod-builder/references/patch-reliability.md`
2. `C:/Users/User/.codex/skills/city-of-gangsters-mod-builder/references/performance-playbook.md`
3. `C:/Users/User/.codex/skills/city-of-gangsters-mod-builder/references/project-map.md`
...
4. The AppData `Player.log` currently shows:
